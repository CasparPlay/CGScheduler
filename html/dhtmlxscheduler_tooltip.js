...
window.dhtmlXTooltip = scheduler.dhtmlXTooltip = window.dhtmlxTooltip = {}, dhtmlXTooltip.config = {
    ...
    return dhtmlXTooltip.hide(), !0
}), scheduler.templates.tooltip_date_format = scheduler.date.date_to_str("%Y-%m-%d %H:%i:%s"), scheduler.templates.tooltip_text = function(e, t, a) {

	var totalSec=(a.duration1)/1000; 
	var hours3 = parseInt( totalSec / 3600 ) % 24;
	var minutes3 = parseInt( totalSec / 60 ) % 60;
	var seconds3 = totalSec % 60; 
	var duration = hours3 + ":" + minutes3 + ":" + seconds3;
        var hour1= (a.end_date).getHours();
        var minute1= (a.end_date).getMinutes(); if(((a.start_date).getTime()== (a.end_date).getTime()) && parseInt(a.duration1) == 0) minute1=0;
	var second1 = (a.end_date).getSeconds();
        var endtime = (a.end_date).getFullYear() + '-' + ((a.end_date).getMonth() + 1) + '-' +  (a.end_date).getDate()+" "+hour1 + ':' +  minute1 + ':' + second1 ;

    return "<b>Server Reference:</b> " + a.text +"<br/><b>Program Name:</b> " + a.program + "&nbsp; &nbsp; <b>Episode Number:</b> " + a.episode + "&nbsp; &nbsp; <b>Segment Number:</b> " + a.segment + "<br/><b>Start date:</b> " + scheduler.templates.tooltip_date_format(e) + "<b>:</b>" + a.sframe + "<br/><b>End date:</b> " + endtime + "<b>:</b>" + a.eframe + "<br/><b>Duration:</b>" + duration + "<b>:</b>" + a.dframe ;
