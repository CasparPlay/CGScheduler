...
window.dhtmlXScheduler = window.scheduler = {
    ...
    _isChrome = !1, _FFrv = !1, _KHTMLrv = !1, _OperaRv = !1, -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0), navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0), -1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0, _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, -1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), dtmlXMLLoaderObject.prototype.doXPath = function(e, t, i, s) {
        ...
        this.catches[e] = t
    }, _dhtmlxError.prototype.throwError = function(e, t, i) { //alert('error');
    ...
    function() {
        ...
        setUpdated: function(e, t, i) { //alert("SetUpdated"+e);
        ...
        }, this._obj.ondblclick = function(e) { //alert("Double Click");
        ...
        dhx_cal_data: function(e) {
            ...
            } else scheduler.callEvent("onEmptyClick", [scheduler.getActionData(e).date, e]); //alert("san" + scheduler.getActionData(e).date);
        ...
        dhx_cal_prev_button: function() { //alert("dhx_cal_prev_button");
	...
	//alert(this._loading);
    ...
    }, scheduler._on_dbl_click = function(e, t) {//alert("dbl");
        ...
        if (t = t || e.target || e.srcElement, !this.config.readonly) { 
            ...
            switch (i) {
                ...
                case "dhx_month_body":
                case "dhx_wa_day_data":  //alert("Double Click"+this.getActionData(e).date);
                    if (!scheduler.config.dblclick_create) break;
			//alert(this._mouse_coords(e).toSource()); //=====Shusmita
			// var t = this._min_date.valueOf() + 6e4 * (this._mouse_coords(e).y * this.config.time_step + 24 * (this._table_view ? 0 : this._mouse_coords(e).x) * 60); alert(this._mouse_coords(e).y +"  *  "+this.config.time_step+" + "+24+"  *  "+ this._mouse_coords(e).x +"  *  "+ 60);
    ...
    }, scheduler._on_mouse_up = function(e) { //alert("mouse");
        if (!e || 2 != e.button || !scheduler.config.touch) {
			...
			//alert(this._drag_event.toSource());		
				//this.showLightbox(t);
	...
	//alert(s.hour_size_px);
    ...
    }, scheduler._reset_hours_scale = function(e, t, i) {//alert(e.toSource());
        ...
        for (var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0), n = 1 * this.config.first_hour; n < this.config.last_hour; n++) {
            ...
            var d = this.xy.scale_width; //r.style.width =d+"px"
            this.config.left_border && (d -= 1, r.className += " dhx_scale_hour_border"), r.style.width =d+"px", r.innerHTML = scheduler.templates.hour_scale(a), s.appendChild(r), a = this.date.add(a, 1 , "hour")  //(divide hour)  sanchita
        }
        ...
        return e
    }, scheduler._get_date_from_pos = function(e) { //alert(e.toSource());
        ...
        var t = this._mouse_coords(e); //alert(t.toSource());
        return {
        ...
        add: function(e, t, i) {
            ...
            switch (i) {
                ...
                case "minute":
                    ...
                    break;
                case "second":
                    s.setTime(s.getTime() + 60 * 60 * t * 1e3);
                    break;
                default:
        ...
        hour_date: "%H:%i:%s ",
        month_day: "%d",
        xml_date: "%m/%d/%Y %H:%i:%s:",
        api_date: "%d-%m-%Y %H:%i:%s",
        preserve_length: !0,
        time_step: 1,
        start_on_monday: 1,
        first_hour: 0,
        last_hour: 24,   //(default 24)
        readonly: !1,
        drag_resize: 1,
        drag_move: 1,
        drag_create: 1,
        ...
        lightbox: {
            sections: [{
                ...
                name: "program name",
                height: 100,
                 map_to: "program", //sanchita
                type: "textarea",
                focus: !0
            }, {//add in object
                name: "formats",
                height: 100,
                 map_to: "format", //sanchita
                type: "select",
                focus: !0
            }, {//add in object
                name: "remarks",
                height: 100,
                map_to: "remarksan", //sanchita
                type: "textarea",
                focus: !0
            }, {//add in object
                name: "durations",
                height: 100,
                map_to: "duration1", //sanchita
                type: "textarea",
                focus: !0
            },{//add in object
                name: "order info",
                height: 100,
                map_to: "order_ref", //sanchita
                type: "order_info",
                focus: !0
            }
	 /*{//add in object
                ...
                name: "bp code",
                height: 100,
                map_to: "bp_code", //sanchita
                type: "textarea",
                focus: !0
            }*/, {//add in object
                name: "description",
                height: 100,
                map_to: "description", //sanchita
                type: "my_editor",
                focus: !0
            }, {//add in object
                name: "prog",
                height: 100,
                map_to: "prog", //sanchita
                type: "program_info",
                focus: !0
            },{//add in object
        ...
        var r = 6e4 * (this.config.event_duration || this.config.time_step);//alert("Shusmi"+r+"  "+n.end_date );
    ...
    function() {
        for (var e = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate","program","Program","format","Format","remark","Remark","duration1","Duration1","description","Description","prog","Prog","serial_type","Serial_type","asset","Asset","input_type","Input_type"], t = function(e) { //sanchita
    ...
    }(), scheduler.event_updated = function(e, t) { //alert("render");
    ...
    }, scheduler.attachEvent("onEventChanged", scheduler._recalculate_timed), scheduler.attachEvent("onEventAdded", scheduler._recalculate_timed), scheduler.render_data = function(e, t) { //alert("onEventChanged Pre Render");
        e = this._pre_render_events(e, t);
	
	//================ Shusmita to show total duration in 30 min slot ===============
	...
	//alert("Render : "+e.text);
        for (var i = 0; i < e.length; i++)
            ...
            if (this._table_view)
                ...
                } else {if(e[i].text== 'New event'){continue;}if(e[i].input_type != 0){continue;}if(parseInt(e[i].duration1)==0 && parseInt(e[i].dframe) == 0){ continue;} if(e[i].id==updatedID && updatedDuration == 0){ continue;}this.render_event(e[i])} //==============Shusmita 13-01-2016
        ...
        this._rendered = []
    }, scheduler.updateEvent = function(e) {  //alert("Update"+e);
        var t = this.getEvent(e); //alert(t.toSource());
	//alert(t.start_date);
        ...
        var t = 60 * e.getHours() + e.getMinutes() + e.getSeconds(); //san
        //alert(t);
        ...
        t = t || 0;
        var i = 60 * e.start_date.getHours() + e.start_date.getMinutes(), //san
    ...
    }, scheduler.render_event = function(e) { //alert("Rendering gggg ");
        ...
        if (!(e._sday < 0)) {
            ...
            if (s) {
                ...
                var so=e.duration1/1000; 
		//s.clientWidth=1800000;
		    ...
		    l = (s.clientWidth*so)/1800,
                ...
                if (0 !== this.xy.menu_width && this._select_id == e.id) { //alert("Rendering menu_width ");
    ...
    }, scheduler._render_v_bar = function(e, t, i, s, a, n, r, d, o) {// alert('left' + t); alert('top' + i);
        //alert("Rendering ");
	var minute2 = (e.start_date).getMinutes();
        var second2 = (e.start_date).getSeconds();
        var pix = (minute2*60)+second2;
	var sp = scheduler.locate_holder(e._sday);

	//========================New Changes by Shusmita

	var endDate=e.end_date;	
	var startDate_1=e.start_date;	
	var countEvent = 0;
	var dateFrom = new Date(startDate_1.getFullYear(),startDate_1.getMonth(),startDate_1.getDate(),00,00,00); 
	var dateTo = new Date(endDate.getFullYear(),endDate.getMonth(),endDate.getDate(),endDate.getHours(),endDate.getMinutes(),endDate.getSeconds());
	//var dateTo1 = new Date(endDate.getFullYear(),endDate.getMonth(),endDate.getDate(),08,29,56);

	var evs = scheduler.getEvents(dateFrom,dateTo); //alert(dateFrom+"   "+dateTo);
	evs.sort(function(a,b){ return (a.start_date > b.start_date && a.sframe > b.sframe ? 1 : -1); }); //alert(evs.toSource());
	for(var j = 0;j<evs.length;j++)
	{
		var tstartDate=evs[j].start_date;
		var tendDate=evs[j].end_date;

		if(evs[j].id == e.id){ //alert("EVS "+evs.length);
		   continue;
		}

		if(updatedID==evs[j].id && updatedDuration == 0) continue;

		if(parseInt(evs[j].duration1) == 0 && parseInt(evs[j].dframe) == 0){ 
			continue;
		}
		if(evs[j].text == "New event"){ //alert("EVS "+evs.length);
		   continue;
		}
		if(evs[j].input_type != 0){continue;}
		/*if(tstartDate.getMinutes() == 00){
			if(evs[j].sframe > 0)
			{ 
				continue; 
			}	
		}
		if(tendDate.getMinutes() == 00){
			if(evs[j].eframe > 0)
			{ 
				continue; 
			}	
		}*/
		if(tstartDate.getHours() == e.start_date.getHours() && tstartDate.getMinutes() == e.start_date.getMinutes() && tstartDate.getSeconds() == e.start_date.getSeconds() && parseInt(evs[j].sframe) >= parseInt(e.sframe)){ 
			 continue;
		}
	...
	var wd = sp.clientWidth;

        var topPix=0;
	var heightPix=20; 
	var hour2=parseInt((e.start_date).getHours());

	/*if(minute2 == 0)
		topPix=200*hour2; 
	else
		topPix=(200*hour2)+(countEvent*heightPix); */
	topPix=(countEvent*heightPix); //alert(topPix);
	...
	var l = document.createElement("DIV"),
        ...
        var u = e.color ? "background:" + e.color + ";" : "",
            ...
            f = '<div event_id="' + h + '" class="' + _ + '" style="position:absolute;top:' + topPix + "px; left:" + 0 + "px; width:" + (wd) + "px; height:" + heightPix + "px;" + (n || "") + '"></div>';

        l.innerHTML = f;
        var v = l.cloneNode(!0).firstChild;
        if (!o && scheduler.renderEvent(v, e, s, a, r, d)) return v;
        v = l.firstChild; 
        //=================Sanchita to divide width into 30 min slot in column =========================
        var m = '<div class="dhx_event_move dhx_header" style=" width:' + (wd) + "px;" + u + '" >&nbsp;</div>';//alert(m);
        var hour= (e.start_date).getHours();
        var hour1= (e.end_date).getHours();
	var minute= (e.start_date).getMinutes();
        var minute1= (e.end_date).getMinutes(); if(((e.start_date).getTime()== (e.end_date).getTime()) && parseInt(e.duration1) == 0) minute1=0;
	var second = (e.start_date).getSeconds();
	var second1 = (e.end_date).getSeconds();
	var time = hour + ':' +  minute + ':' + second+":"+e.sframe	
        var time2 = hour1 + ':' +  minute1 + ':' + second1 + ':' + e.eframe
	//var totalSec=(e.end_date.getTime()-e.start_date.getTime())/1000;
	var totalSec=(e.duration1)/1000;  
	var hours3 = parseInt( totalSec / 3600 ) % 24;
	var minutes3 = parseInt( totalSec / 60 ) % 60;
	var seconds3 = totalSec % 60;
	var duration = hours3 + ":" + minutes3+ ":" + seconds3+":"+e.dframe; 
        var frame= parseInt(e.sframe) + parseInt(e.dframe); 
        var rtitle=(r.split('-')[0]).trim()+":"+e.sframe+" - "+(r.split('-')[1])+":"+e.eframe;

	d = 'Start Time: ' + ' ' + time+ '&nbsp &nbsp' + ' Program Name : ' + e.program+'&nbsp &nbsp' + 'End Time: ' + ' ' + time2 +' &nbsp &nbsp' + 'Duration : ' + ' ' +duration +  '&nbsp &nbsp' + '&nbsp &nbsp' + 'Remarks: ' + ' ' + e.remark +  '&nbsp &nbsp';

        m += '<div class="dhx_event_move dhx_title" style="height:'+ heightPix +'px;border:0px solid red;text-align:left;font-size:14px;' + u + g + '">' + "" + " ", m +=  d + "</div>";
        var p = "dhx_event_resize dhx_footer"; 

        return o && (p = "dhx_resize_denied " + p), m += '<div class="' + p + '" style="display:none; height : 0px;width:' + (wd) + "px;" + (o ? " margin-top:-1px;" : "") + u + g + '" ></div>',
            v.innerHTML = m, v
	...
	obj_value = m;
        ...
        textarea: {
            render: function(e) {
                ...
                return "<div class='dhx_cal_ltext' style='height:" + t + ";border:0px solid red'><textarea></textarea></div>"
            },
        ...
        time: {
                    ...
                    switch (d > 0 && (r += " "), o) {
                        ...
                        case "%H:%i":
                            ...
                            for (e._time_values = []; a > h;) {
                                ...
                                h = 24 * u * 60 + 60 * s.getHours() + s.getMinutes() //san
                            } 
                            r += "</select>"
                    }
                }
            ...
            set_value: function(e, t, i, s) {
			 ...
			 var e = scheduler._lightbox_out({}, scheduler._lame_copy(scheduler.getEvent(scheduler._lightbox_id)));//alert("san");
		         d.event_duration=e.duration1;
		...
		//alert(i.toSource());
	    //alert(i.program);  //sanchita
	   // alert(s.toSource());
        scheduler.templates.lightbox_header ? (s[1].innerHTML = "", s[2].innerHTML = scheduler.templates.lightbox_header(i.start_date, i.end_date, i,i.text1,i.text2)) : (s[1].innerHTML = this.templates.event_header(i.start_date, i.end_date, i),
		...
		// alert(i.toSource());
	     if(i.text == 'New event'){
		    ...
		    var day=(i.start_date).getDate();
		    var month=(i.start_date).getMonth()+1;
		    if((i.start_date).getMonth() < 10) { month='0'+month;}
		    if((i.start_date).getDate() < 10) { day='0'+(i.start_date).getDate();}
		    document.getElementById("date1").value=((i.start_date).getFullYear()+ '-' +month + '-' + day);
		    //if(e.input_type == "1"){
			    document.getElementById("hour").value=(i.start_date).getHours();
			    document.getElementById("minute").value=(i.start_date).getMinutes();
			    document.getElementById("second").value=(i.start_date).getSeconds();
			    document.getElementById("millisecond").value=(i.sframe);
		   // }
		  if(i.input_type=="1")	document.getElementById("segment").value=i.description;

		//alert(document.getElementById("segment").value);
	}
	else{
			
		     document.getElementById("prog").value=i.program;
		     document.getElementById("episode").value=i.episode;
		     document.getElementById("segment").value=i.segment;
		  if(i.input_type=="1")	document.getElementById("segment").value=i.description;
		  if(i.serial_type=="BONUS") document.getElementById("serial_type").checked=true ; 
		  else document.getElementById("serial_type").checked=false;

		    // var option = document.createElement("option");
		   //  option.text = i.order_ref;
		    // option.value = i.order_ref;
		    // document.getElementById("order_ref").appendChild(option);
		    ...
		    document.getElementById("millisecond").value=(i.sframe);
		    if(i.text == 'COM'){
		     document.getElementById("rate_agreement").value=i.rate_agreement; 
			var startDate= (i.start_date).getFullYear()+ '-' +month+ '-' + day;	
			var sendDate=startDate+";"+i.rate_agreement; 
		    ...
		    var dDuration=i.duration1;
		    var dmSec=parseInt(dDuration)%1000; 
		    dDuration=parseInt(dDuration)-parseInt(dmSec);
		    var dSec=(parseInt(dDuration)/1000)%60; 
		    dDuration=(parseInt(dDuration)/1000)-parseInt(dSec);
		    var dmin=(parseInt(dDuration)/60)%60; 
		    dDuration=(parseInt(dDuration)/60)-parseInt(dmin);
		    var dhour = (parseInt(dDuration)/60);
		    document.getElementById("dhour").value=dhour;
		    document.getElementById("dminute").value=dmin;
		    document.getElementById("dsecond").value=dSec;
		    document.getElementById("dmillisecond").value=i.dframe;
		    var eminute=(i.end_date).getMinutes();
		   // if(parseInt(i.duration1) == 0)
		    if(((i.start_date).getTime()== (i.end_date).getTime()) && parseInt(i.duration1) == 0){
			eminute=parseInt((i.end_date).getMinutes())-1;
		    }

		    document.getElementById("date2").value=((i.end_date).getFullYear()+ '-' +((i.end_date).getMonth() + 1) + '-' + (i.end_date).getDate())+"  "+(i.end_date).getHours()+":"+eminute+":"+(i.end_date).getSeconds() +":"+i.eframe;
	}
            s[2].innerHTML = s[2].innerHTML+ ' ' + str+ ' ' + str1+ ' ' + str2+ ' ' + str3;
		 //alert( s[2].innerHTML);
		 //alert(i.end_date-i.start_date);
		 // alert(s[2].innerHTML);
	...
	//alert(e.toSource());
        return e
    }, scheduler._empty_lightbox = function(e) { //alert(e.toSource());
        {
            var t = scheduler._lightbox_id,
 	   // var t = e.id,
                i = this.getEvent(t); //alert(i.toSource());
            this.getLightbox()
        }
        this._lame_copy(i, e), 
	this.setEvent(i.id, i),
	this._edit_stop_event(i, !0) 
	this.render_view_data() //====blocked by Shusmita
        ...
        var e = this._lightbox_out({}, this._lame_copy(this.getEvent(this._lightbox_id))); //alert(e.toSource());
	var newEventID=(this.getEvent(this._lightbox_id)).id;

	if(e.asset == "" && !e.text.contains("LIVE") ){ //e.text != "LIVE" 
		alert("Asset ID Not Found. Please provide correct name.");
		return;
	}

	

	var date1 = new Date(e.start_time); //alert(date1);
	var date2 = new Date(e.end_time);
        var pro= e.prog;
       // alert(pro);
	//alert( e.toSource());
	e.start_date=date1;
	...
	/*----------priyanka,start changes-----------*/
	
	var date = new Date(e.start_date);
	var Enddate = new Date(e.end_date);
	var eventSFrame=e.sframe;
	var eventEFrame=e.eframe;

	var today_date = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' +  date.getDate();
	var today_hour = date.getHours();
	var todate_minute = date.getMinutes();
	var todate_second = date.getSeconds();
	
	/*-----------end date--------------------*/
	var end_date = new Date(e.end_date); 
	var today_enddate = end_date.getFullYear() + '-' + (end_date.getMonth() + 1) + '-' +  end_date.getDate();
	var today_endhour = end_date.getHours();
	var todate_endminute = end_date.getMinutes();
	var todate_endsecond = end_date.getSeconds();
	...
	var prg_totalSec = 0;
	var com_totalSec = 0;
	var prg_time = e.duration1/1000;
	var prg_frame= parseInt(e.dframe);
	var p_frame = 0;
	var left_p_frame = 0;
	...
	if(today_date != today_enddate)
	{
		//alert("Start date and end date must be same");
	}

	dateFrom = new Date(date.getFullYear(),date.getMonth(),date.getDate(),00,00,00); //Changed for 1 hour slot on 26-11-15
	dateTo = new Date(date.getFullYear(),date.getMonth(),date.getDate(),24,00,00); //Changed for 1 hour slot on 26-11-15

	var prg_time1 = parseInt(prg_time) + (prg_frame*0.04);
	prg_time1 = prg_time1.toFixed(2);

	if(e.input_type != "0" && prg_time1 <= 0){
		alert(' Duration can not be zero.');
		return;
	}

	if( prg_time1 > 0 && (e.text == 'COM' && e.rate_agreement == ""))
	{
		alert(' Rate Agreement is mandatory for Commercical.');
		return;			
	}

	if(e.text == 'COM' && prg_time1 > 1020)
	{
		alert(' Commercical is not allowed more than 17 min');
		return;
					
	}

	//=================sort evs======================================//
	var evs = scheduler.getEvents(dateFrom,dateTo); //alert(evs.toSource());
	evs.sort(function(a,b){ return (a.start_date > b.start_date ? 1 : -1); });
	var checkTotalDuration=parseInt(e.duration1)/1000+(parseInt(prg_frame)*0.04);
	var checkTotal_Dframe=0;
	var immi_sframe = 0;
	var length = 0; 

	var eventStartDate = null;
	var eventStartFrame = 0;
	var eventEndDate = null;
	var eventEndFrame = 0;
	for(var i = 0;i<evs.length;i++)
	{
		
		var tstartDate=evs[i].start_date;
		var tendDate=evs[i].end_date;
		if(evs[i].id == newEventID)
		{ 
			continue; 
		}
		if(tstartDate.getFullYear() != date.getFullYear() && tstartDate.getMonth()!=date.getMonth() && tstartDate.getDate()!= date.getDate())
		{ 
			continue; 
		}
		length = length + 1;

		immi_sframe = evs[i].eframe; 

		
		checkTotalDuration=checkTotalDuration+parseInt((evs[i].duration1)/1000)+(parseInt(evs[i].dframe)*0.04);
		total_duration = total_duration + parseInt(evs[i].duration1);
		total_dframe = total_dframe+ parseInt(evs[i].dframe);

		eventStartDate = tendDate;
		eventStartFrame =parseInt(evs[i].eframe);
	}
	
//===================== Set Start Date and End Date for events =================
	...
	if(length == 0)
	{
		for(var i = 0;i<evs.length;i++)
		{
			if(evs[i].id == newEventID)
			{
				...
				e.start_date = dateFrom;
				e.end_date = new Date(dateFrom.getTime() + e.duration1);
				e.sframe = "0";
				e.eframe = e.dframe;
			}
		}
	...
	if(length > 0 && (e.input_type == ""))  
	{

		e.start_date = eventStartDate;
		e.sframe =eventStartFrame;

		var total_Sec = (eventStartDate.getTime()+parseInt(e.duration1))/1000;
		var frameSec = 0;
		var frame1 = 0;
		eventEndFrame=eventStartFrame+parseInt(e.dframe);
		if(eventEndFrame>24)
		{
		...
		e.end_date = new Date(total_Sec);				
		e.eframe =  frame1;
	}

	/*var cdate = new Date(e.start_date);
	var ctodate_minute = cdate.getMinutes();

	var cend_date = new Date(e.end_date);
	var ctodate_endminute = cend_date.getMinutes();*/

	checkTotalDuration=checkTotalDuration.toFixed(2);//alert(""+checkTotalDuration);
	if(checkTotalDuration > 86400) //Changed for 1 hour slot on 26-11-15
	{
		alert("You are crossing your 24 hour slot "+checkTotalDuration);
		return;
	}

	myfunction(e); //cal myfunction to update,save
            ...
            if (t.className || (t = t.previousSibling), t && t.className) switch (t.className) {
                ...
                case "dhx_delete_btn":  
				 ...
				 document.getElementById("dsecond").value=parseInt(0);
                                 document.getElementById("dmillisecond").value=0;
				 scheduler.save_lightbox(); //return; ==============Shusmita to stop delete
    ...
    scheduler._init_touch_events = function() {
        ...
        e._methods = ["_set_event_text_style", "", "changeEventId", "_dp_hook_delete"], this._dp_hook_delete = function(e) {
            ...
            }), this.attachEvent("onEventChanged", function(t) { //alert("onEventChanged");
    ...
    var send_eventStartTime=null;
    var send_eventStartFrame=0;
    var send_eventEndTime=null;
    var send_eventEndFrame=0;
    var send_id=0;

    function myfunction(e)
    {
	eObj=e;
	id=(scheduler.getEvent(scheduler._lightbox_id)).id;
        promise = longfunctionfirst(e).then(shortfunctionsecond);
    }

    function longfunctionfirst(e)
    {
	...
	var isUpdate=false;
        setTimeout(function(){
	if((e.input_type == "1") || (e.input_type == "0") || (e.input_type == "")){ 

		var month=e.start_date.getMonth()+1;
		var month1=e.end_date.getMonth()+1;
		var day=e.start_date.getDay();
		var day1=e.end_date.getDay();

		var h=e.start_date.getHours();
		var h1=e.end_date.getHours();
		var s=e.start_date.getSeconds();
		var s1=e.end_date.getSeconds();
		var m=e.start_date.getMinutes();
		var m1=e.end_date.getMinutes();
		var day=e.start_date.getDate();
		var day1=e.end_date.getDate();
		...
		if(parseInt(h1) < 10) {h1="0"+h1;}
		if(parseInt(s) < 10) {s="0"+s;}
		if(parseInt(s1) < 10) {s1="0"+s1;}
		if(parseInt(m) < 10) {m="0"+m;}
		if(parseInt(m1) < 10) {m1="0"+m1;}

		var send_start_date = (e.start_date).getFullYear()+"-"+month+"-"+day+" "+h+":"+m+":"+s; 
		var send_end_date = e.end_date.getFullYear()+"-"+month1+"-"+day1+" "+h1+":"+m1+":"+s1; 
		var newEventID=(scheduler.getEvent(scheduler._lightbox_id)).id;
		updatedID=newEventID;
		updatedDuration=parseInt(e.duration1)+parseInt(e.dframe); //alert(e.toSource());
		var sendData=send_start_date+";"+send_end_date+";"+e.sframe+";"+e.eframe+";"+newEventID+";"+e.input_type+";"+e.duration1+";"+e.dframe+";"+e.text+";"+e.program+";"+e.asset+";"+e.serial_type+";"+e.remark+";"+e.episode+";"+e.segment+";"+e.rate_agreement;	//alert(sendData);
		 $.post(                          
			"UpdateEvents.php",     
		{
			field: "name",
			...
			function(data)
			{  
			     var obj = JSON.parse(data);  //alert("obj"+obj);		
				...
				alert("Could not save. "+msg);
				  ...
				  /*  var splitObj=obj.split(";"); 
				    send_id= (splitObj[0].split("?"))[1]; //alert("pp"+splitObj[0]);
				    var splitInfo_1=splitObj[1];
				    var splitInfo=splitInfo_1.split("|"); 

				    var sdate_split=splitInfo[0].split(" "); 
				    var sdate_date=sdate_split[0].split("-");
				    var y1=sdate_date[0];
				    var m1=parseInt(sdate_date[1])-1;
				    var d1=parseInt(sdate_date[2]);
				    var sdate_time=sdate_split[1].split(":");
				    var h1=sdate_time[0];
				    var min1=parseInt(sdate_time[1]);
				    var sec1=parseInt(sdate_time[2]);
				    send_eventStartTime=new Date(y1,m1,d1,h1,min1,sec1); 

				    send_eventStartFrame=splitInfo[1];

				    var edate_split=splitInfo[2].split(" "); 
				    var edate_date=edate_split[0].split("-");
				    var y2=edate_date[0];
				    var m2=parseInt(edate_date[1])-1;
				    var d2=parseInt(edate_date[2]);
				    var edate_time=edate_split[1].split(":");
				    var h2=edate_time[0];
				    var min2=parseInt(edate_time[1]);
				    var sec2=parseInt(edate_time[2]);
				    send_eventEndTime=new Date(y2,m2,d2,h2,min2,sec2); //new Date(splitInfo[2]*1000);
				    send_eventEndFrame=splitInfo[3];*/
...
var dateView=null;
	...
	setTimeout(function(){ 
		if(isHide == true){			
			 var inputType=eObj.input_type; //alert("inputType "+inputType);
			 //if(eObj.input_type=="" || eObj.input_type=="1"){ 
				eObj.input_type="0";
				eObj.start_date = send_eventStartTime;
				eObj.sframe =  send_eventStartFrame;
				eObj.end_date =  send_eventEndTime;
				eObj.eframe =  send_eventEndFrame; 
			//	(!scheduler.checkEvent("onEventSave") || scheduler.callEvent("onEventSave", [scheduler._lightbox_id, eObj, scheduler._new_event])) && (scheduler._empty_lightbox(eObj), scheduler.hide_lightbox());
			//}
			if(inputType == ""){ eObj.id=send_id; 
