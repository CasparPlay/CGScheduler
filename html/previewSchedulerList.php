...
<form id="form1" name="form1" method="post" action="">
	...
	<div id='printArea'><p align="center" style="font-family: verdana; font-weight: bold; font-size: 14px;color:black">Scheduler List for <?php echo $date2; ?> </p>
	...
	<tr bgcolor='#AAA7A7'>
		...
		<td align="center"><span align="left" style="font-family: verdana;font-family: verdana; font-size: 12px;color:black"><strong>Formats</strong></span></td>
	</tr>
	<?php 
	if ($result <> null) { 
	$count=0;
	...
	?>
		...
		<td align="center"><span align="center" style="font-family: verdana; font-size: 11px;"><?php echo $row["format"]; ?></span></td>
	      </tr>
