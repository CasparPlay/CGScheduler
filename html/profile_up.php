<?php 
 ...
 $fnameErr=$lnameErr=$usernameErr = $emailErr = $contactErr = $addressErr = $passErr = $repassErr=$err="";

if (isset($_POST['submit'])) {

   if (empty($_POST["fname"]))
     {$fnameErr = "First Name is required"; $err=$fnameErr;}
   else
     {$fname = test_input($_POST["fname"]);}
   if (empty($_POST["lname"]))
      {$lnameErr = "Last Name is required"; $err= $lnameErr;}
   else
   {$lname = test_input($_POST["lname"]); }
   if (empty($_POST["username"]))
     {$usernameErr = "Username is required"; $err=$usernameErr;}
   else
     {
   ...
   if (empty($_POST["email"]))
     {$emailErr = "Email is required"; $err=$emailErr;}
   else
     {
   ...
   if (empty($_POST["contact"]))
     {$contactErr = "Contact No is required"; $err=$contactErr;}
   else
     {
   ...
   if (empty($_POST["address"]))
     {$addressErr = "Address is required"; $err=$addressErr;}
   else
     {$address = test_input($_POST["address"]);}

   if (empty($_POST["password"]))
     {$passErr = "Password is required"; $err=$repassErr;}
   else
     {$password = test_input($_POST["password"]);}
	if (empty($_POST["repassword"]))
     {$repassErr = "Confirm Your Password"; $err=$repassErr;}
   else
     { if ($_POST["repassword"] !=$password )
	 	{$repassErr = "Password not matched."; $err=$repassErr="Error";}
...
<tr>
	<td style="width: 300px;"><label style="font-size: 20px; " for="user">First Name</label></td> 
...
<tr>
	<td style="width: 200px;"><label style="font-size: 20px; " for="user">Last Name</label></td> 
...
<tr >
	<td style="width: 200px;"><label style="font-size: 20px; " for="user">Email</label></td> 
...
<tr>
	<td style="width: 200px;"><label style="font-size: 20px; " for="user">Contact No</label></td>
 ...
 <tr>
   	<td style="width: 200px;"><label style="font-size: 20px; " for="user">Address</label></td> 
...
<tr>
<td style="width: 200px;"><label style="font-size: 20px; " for="user">Username</label></td> 
...
<tr>
 	<td style="width: 200px;"><label style="font-size: 20px; " for="user">Password</label></td>
