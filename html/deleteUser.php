...
if (isset($_POST['submit'])) {
	...
	if($err==""){
			$sql = "Delete from registration where user_id = '$name' and reg_id =' $reg_id' ";

			mysql_query($sql,$link) or die("falied to delete.."); 
...
<div style="margin-left: 450px; margin-top: 15px;"> <input style="width:120px;height:35px;font-weight:bold" id="submit" name="submit" type="submit" value="Delete" onClick="return submit_Form()"/> </div>
</form>
</div>
