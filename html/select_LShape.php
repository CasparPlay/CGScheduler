...
var p="<div class='dhx_cal_ltext' style='height:50px;border:1px solid red;color:black;'>Program Name :<div style='border:0px solid blue;margin-left:70px;width:50px;height:30px;margin-top:-10px' class='dhx_cal_navline'></div><input style='border:1px solid blue;margin-top:10px;margin-left:10px;height:30px;width:100px' type='text' id='prog' name='prog' onchange='getAssetID()' >&nbsp; Episode Number :<input style='border:1px solid blue;margin-top:10px;margin-left:10px;height:30px;width:50px' type='text' id='episode' name='episode' onchange='getAssetID()' >&nbsp; Segment Number :<input style='border:1px solid blue;margin-top:10px;margin-left:10px;height:30px;width:50px' type='text' id='segment' name='segment' onchange='getAssetID()' ></div>";
			...
			for (var i=0; i<60/step; i++){
				...
				html+="<div id='"+'slot'+id+"' style='height:100px;line-height:15px;border-bottom:1px solid #CECECE;color:black;font-size:14px'></div>";
