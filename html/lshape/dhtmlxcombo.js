...
dhtmlXCombo.prototype.setComboValue = function(a) {
    this.setComboText(a);
    for (var b = 0; b < this.optionsArr.length; b++)
        if (this.optionsArr[b].data()[0] == a) return this.selectOption(b, null, !0);
...
dhtmlXCombo.prototype._listOver = function(a) {
    ...
    if (b.parentNode == c.DOMlist) {
        ...
        for (var e = 0; e < c.DOMlist.childNodes.length; e++)
            if (c.DOMlist.childNodes[e] == b) break;
...
dhtmlXCombo.prototype._onKeyB = function(a) {
    if (a == "40") var b = this.selectNext(1);
        ...
        for (var c = 0; c < this.optionsArr.length; c++)
            if (this.optionsArr[c].data()[1] == this.DOMelem_input.value) return this.selectOption(c, !1, !1), !1;
        this.unSelectOption()
    }
    return !0
};
...
dhtmlXCombo.prototype._fillFromXML = function(a, b, c, e, d) {
    ...
    if (f.tagName != "complete") a._load = !1;
        ...
        if (!h[0] || !h[0].getAttribute("add")) {
            if (a.clearAll(), a._lastLength = g.length, a._xml)
                if (!g || !g.length) a.closeAll();
...
function dhtmlXRange(a, b, c) {
    ...
    c > f && (c = f);
    if (b != c)
        if (e.setSelectionRange) e.setSelectionRange(b, c);
        ...
        var b = [],
            ...
            d = function() {
                ...
                for (var d = 0; d < b.length; d++)
                    if (b[d] != null) var e = b[d].apply(c, arguments),
                        a = a && e;
                return a
            };
